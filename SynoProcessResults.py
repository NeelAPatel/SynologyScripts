...
class ProcessingResult:
    ...
    def set_total_file_types(self, file_type_list: list):
        # if file_type not in self.file_types_to_process:
        #     self.file_types_to_process.append(file_type)
        
        # Copy list into self.file_types_to_process
        self.save_results()

    def add_folder_to_process(self, folder_path: str, total_media_count: int):
    ...
    def summary(self):
        return {
            "paths_to_process": self.paths_to_process,
            "file_types_to_process": self.file_types_to_process,
